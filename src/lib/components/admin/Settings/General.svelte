		...
		{#if adminConfig !== null}
			<div class="">
				...
				<div class="mb-3">
					...
					<div class="mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-xs font-medium">{$i18n.t('Deepze URL')}</div>
						</div>
						...
						<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(
								'Enter the public URL of your Deepze. This URL will be used to generate links in the notifications.'
							)}
						</div>
					</div>
