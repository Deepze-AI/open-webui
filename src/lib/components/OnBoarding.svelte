...
{#if show}
	<div class="w-full h-screen max-h-[100dvh] text-white relative">
		...
		<div
			class="w-full h-full absolute top-0 left-0 bg-linear-to-t from-10% from-black to-transparent"
		></div>

		<div class="w-full h-full absolute top-0 left-0 backdrop-blur-xs bg-white/60"></div>
